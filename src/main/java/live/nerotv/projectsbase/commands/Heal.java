        ...
        if (cmd.getName().equalsIgnoreCase("Heal")) {
            if (!(s instanceof Player)) {
                if (args.length == 0) {
                    ...
                    p.setFoodLevel(20);
                    p.setFireTicks(0);
                    API.sendMessage((CommandSender)p, "Du wurdest \u00a7ageheilt\u00a77!");
                ...
                if (s.hasPermission("zyneon.team")) {
                    if (args.length == 0) {
                        ...
                        p.setFoodLevel(20);
                        p.setFireTicks(0);
                        API.sendMessage((CommandSender)p, "Du hast dich \u00a7ageheilt\u00a77!");
                    } else if (Bukkit.getPlayer((String)args[0]) != null) {
                        Player t = Bukkit.getPlayer((String)args[0]);
                        t.setHealth(20.0);
                        t.setFoodLevel(20);
                        t.setFireTicks(0);
                        API.sendMessage((CommandSender)t, "Du wurdest \u00a7ageheilt\u00a77!");
                        API.sendMessage((CommandSender)p, "Du hast den Spieler \u00a7e" + t.getName() + "\u00a7a geheilt\u00a77!");
                    } else {
